...
(https://github.com/blindconf/fingerprint/) # Arxiv submission
"""
import argparse
import torch
import pickle
...
vocoders_paper = ["ljspeech_melgan_train.csv", 'ljspeech_melgan_test.csv',
                    ...
                    "ljspeech_lbigvgan_train.csv", "ljspeech_lbigvgan_test.csv", "A16_test.csv", "A19_test.csv"]

# Iterate Experiments through all filters in NEW_FILTERS
FILTERS = {"EncodecFilter": EncodecFilter,
           "Oracle": OracleFilter,
           ...
           # "AllPassBiQuadFilter": AllPassBiQuadFilter,
...
def parse_args():
    ...
    parser.add_argument("--corpus", choices=["ljspeech", "jsut", "asvspoof", "asvspoof_val"], default="ljspeech")
    ...
    parser.add_argument("--filter-param", type=str, default="24", help="Parameter of the filter.")
    ...
    if args.num_train is None:
        ...
        elif args.corpus == "asvspoof_val":
            args.num_train = 4668
        else:
            args.num_train = 6012 # 3800
...
def main(args):
    ...
    if args.fake_data_path != None:
        ...
        auc_path = get_auc_path(args, args.fake_data_path) 
    # print(auc_path)
    ...
    if args.perturbation == "noise":
        ...
        if not os.path.exists(dir_data_files):
            ...
            generate_csv_files(
                    ...
                    args.seed)
    # print(Asfasfd)
    print("dir_data_files: ", dir_data_files)
    ...
    if args.vocoders == "paper" and args.corpus != 'asvspoof_val':
    ...
    # '''
        ...
        for test_path in TEST_CSV:
            ...
            print(name_test, args.filter_param, args.nfft, args.num_test)
            # print(test_file)
